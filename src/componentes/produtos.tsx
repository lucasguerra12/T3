                            ...
                            onClick={() =>
                                abrirModal(
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <label className={labelStyle} htmlFor="produto_codigo_att">Código do Produto</label>
                                        <input id="produto_codigo_att" className={inputStyle} type="text" placeholder="Insira o código do produto" />

                                        <label className={labelStyle} htmlFor="produto_nome_att">Novo Nome</label>
                                        <input id="produto_nome_att" className={inputStyle} type="text" />

                                        <label className={labelStyle} htmlFor="produto_valor_att">Novo Valor</label>
                                        <input id="produto_valor_att" className={inputStyle} type="text" />
                            ...
                            onClick={() =>
                                abrirModal(
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <label className={labelStyle} htmlFor="produto_codigo_del">Código do Produto</label>
                                        <input id="produto_codigo_del" className={inputStyle} type="text" placeholder="Insira o código do produto"/>
